...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    client: 'TRL Diagnostic',
    title: 'TRL Diagnostic Web Calculator',
    cat: ['Web'],
    status: 'deployed',
    platform: 'Web',
    short: 'A web-based diagnostic calculator built for TRL Diagnostic to streamline clinical result interpretation.',
    long: 'A web-based diagnostic calculator built for TRL Diagnostic, designed to streamline the interpretation of clinical results and give practitioners a fast, reliable tool for diagnostic decision support.',
    tech: ['React', 'TypeScript', 'Web App'],
    outcome: 'Live and in use by TRL Diagnostic for clinical result interpretation.',
  },
  {

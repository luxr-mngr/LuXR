...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    long: 'An XR platform for exploring and manipulating high-fidelity photogrammetry-digitized Peruvian archaeological artifacts that are otherwise unexhibited or physically inaccessible. Designed for museum visitors and the general public, VestoXR brings multiple Peruvian collections into immersive spatial experiences, letting users pick up, examine, and interact with artifacts at full scale.',
  ...
  },
  {
    ...
    client: 'PUCP Biomedical',
    title: 'TRL Diagnostic Web Calculator',
    cat: ['Web'],
    status: 'deployed',
    platform: 'Web',
    short: 'A web tool that maps diagnostic devices onto the 1-9 Technology Readiness Level scale to track their maturity.',
    long: 'A web-based calculator for PUCP researchers that maps diagnostic devices onto the 1-9 Technology Readiness Level (TRL) scale, from early idea generation through to commercial market launch, helping teams measure and communicate device progression across clinical and regulatory milestones.',
    tech: ['React', 'TypeScript', 'Web App'],
    outcome: 'Live and in use for PUCP biomedical device research.',
  },
  {
